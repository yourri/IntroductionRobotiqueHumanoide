...
uLINK(5) = struct('name','MP_TIBIA_L' , 'm',  0.070309794, 'sister', 0, 'child', 6, 'b',[-0.093 0 0]' ,'a',UY,'q',0);
uLINK(6) = struct('name','MP_ANKLE1_L' , 'm',  0.16710792, 'sister', 0, 'child', 7, 'b',[-0.093 0 0]' ,'a',-UY,'q',0);
...
uLINK(11)= struct('name','MP_TIBIA_R' , 'm',  0.070309794, 'sister', 0, 'child',12, 'b',[-0.093 0 0]' ,'a',UY,'q',0);
uLINK(12)= struct('name','MP_ANKLE1_R' , 'm',  0.16710792, 'sister', 0, 'child',13, 'b',[-0.093 0 0]' ,'a',UY,'q',0);
