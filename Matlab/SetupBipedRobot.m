...
uLINK(3) = struct('name','MP_THIGH1_L' , 'm',  0.11904336, 'sister', 0, 'child', 4, 'b',[0 0 -0.028652]'   ,'a',UZ,'q',0);
uLINK(4) = struct('name','MP_THIGH2_L' , 'm',  0.11904336, 'sister', 0, 'child', 5, 'b',[0 0 0]','a',UZ,'q',0);
uLINK(5) = struct('name','MP_TIBIA_L' , 'm',  0.070309794, 'sister', 0, 'child', 6, 'b',[0 0 -0.093]' ,'a',UZ,'q',0);
uLINK(6) = struct('name','MP_ANKLE1_L' , 'm',  0.16710792, 'sister', 0, 'child', 7, 'b',[ 0 0 -0.093]' ,'a',UZ,'q',0);
uLINK(7) = struct('name','MP_ANKLE2_L' , 'm',  0.0794462, 'sister', 0, 'child', 0, 'b',[0  0   0]' ,'a',UZ,'q',0);

uLINK(8) = struct('name','MP_PELVIS_R' , 'm',  0.197, 'sister', 0, 'child', 9, 'b',[-0.005 -0.037 -0.09355]'   ,'a',UZ,'q',0);
uLINK(9) = struct('name','MP_THIGH1_R' , 'm',  0.11904336, 'sister', 0, 'child',10, 'b',[0 0 -0.028652]'   ,'a',UZ,'q',0);
uLINK(10)= struct('name','MP_THIGH2_R' , 'm',  0.11904336, 'sister', 0, 'child',11, 'b',[0 0 0]'   ,'a',UZ,'q',0);
uLINK(11)= struct('name','MP_TIBIA_R' , 'm',  0.070309794, 'sister', 0, 'child',12, 'b',[ 0 0 -0.093]' ,'a',UZ,'q',0);
uLINK(12)= struct('name','MP_ANKLE1_R' , 'm',  0.16710792, 'sister', 0, 'child',13, 'b',[ 0 0 -0.093]' ,'a',UZ,'q',0);
uLINK(13)= struct('name','MP_ANKLE2_R' , 'm',  0.0794462, 'sister', 0, 'child', 0, 'b',[0  0   0]' ,'a',UZ,'q',0);
